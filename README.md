# mutt_murah_api-2-json

Dockerized ComfyUI workflow: mutt_murah_api (2).json
...
docker build -t mutt_murah_api-2-json .

# Run the container
docker run -p 8188:8188 mutt_murah_api-2-json
```
